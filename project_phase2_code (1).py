...
Original file is located at
    https://colab.research.google.com/drive/1ObxdK5e2RmyD5YovuzkljkCbL1G5AgZ5
"""
...
# Prediction function
def predict_grade(study_hours, past_grade, attendance):
...
app = gr.Interface(
    fn=predict_grade,
    inputs=[
        gr.Slider(0, 24, value=6, label="Study Hours"),
        gr.Slider(0, 100, value=70, label="Past Grade"),
        gr.Slider(0, 100, value=85, label="Attendance (%)")
    ],
    outputs="text",
    title="🎓 Final Grade Predictor",
    description="Enter student data to predict their final grade."
)
...
def predict_final_grade(study_hours, past_grade, attendance):
    input_df = pd.DataFrame([[study_hours, past_grade, attendance]],
                            columns=['StudyHours', 'PastGrade', 'Attendance'])
    predicted = model.predict(input_df)[0]
    return f"📘 Predicted Final Grade: {predicted:.2f}"

# Step 4: Build Gradio interface
app = gr.Interface(
    fn=predict_final_grade,
    inputs=[
        gr.Slider(0, 24, step=1, label="Study Hours"),
        gr.Slider(0, 100, step=1, label="Past Grade"),
        gr.Slider(0, 100, step=1, label="Attendance (%)")
    ],
    outputs="text",
    title="🎓 Final Grade Predictor",
    description="Enter the student's study hours, past grade, and attendance to predict their final grade."
)
